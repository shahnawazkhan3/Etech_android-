...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String Artist_ID = "";
    ...
    protected void onStart() {
        ...
        lists.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Tb_Artist artist =artists.get(i);

                Intent addtrctIntent = new Intent(getApplicationContext(),AddtrctActivity.class);
                addtrctIntent.putExtra(Artist_ID,artist.getArtistID());
                addtrctIntent.putExtra(Artist_name,artist.getArtistName());
                startActivity(addtrctIntent);
            }
        });
    }
}
